...
public class MessageDatabaseProvider extends ContentProvider {

    private static MessageDatabaseHelper openHelper;

    private static final String PROVIDER_ID =
            "pollub.edu.pl.kolokwium1.MessageDatabase.MessageDatabaseProvider";
    ...
    public boolean onCreate() {
        openHelper=new MessageDatabaseHelper(getContext());
        return true;
    }
